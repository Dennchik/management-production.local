		...
		<div class="receipt-order__body">
			...
			<div class="receipt-order__line">
				...
				<fieldset class="receipt-order__field">
					<label class="receipt-order__label" for="material_select">
						Материал
					</label>
				...
				<fieldset class="receipt-order__field">
					...
					<label class="receipt-order__label" for="grammage">
						Граммаж
					</label>
					...
					<div class="receipt-order__rolls-list" data-receipt-rolls>
						...
						<div class="receipt-order__roll" data-receipt-roll>
							...
							<fieldset class="receipt-order__field">
								...
								<label class="receipt-order__label" for="roll_number_0">
									Номер рулона
								</label>

								<input class="receipt-order__input" id="roll_number_0" name="rolls[0][roll_number]"
										type="text" value="{{ old('rolls.0.roll_number') }}">

							</fieldset>

							<fieldset class="receipt-order__field">

								<label class="receipt-order__label" for="weight_0">
									Вес, кг
								</label>

								<input class="receipt-order__input"
										id="weight_0"
										name="rolls[0][weight]"
										type="number"
										step="0.001"
							...
							<button class="receipt-order__roll-remove button"
									type="button"
