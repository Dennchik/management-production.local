	...
	<form class="issue-order" method="POST" action="{{ route('material-issues.store') }}" novalidate>
		...
		<div class="issue-order__body">
			...
			<div class="issue-order__line">
				...
				<fieldset class="issue-order__field">
					<label class="issue-order__label" for="remaining_weight">Остаток, кг</label>
					<input class="issue-order__input" id="remaining_weight" type="text" readonly>
				</fieldset>
				{{-- Вес расхода --}}
				<fieldset class="issue-order__field">
					<label class="issue-order__label" for="weight">Вес расхода, кг</label>
