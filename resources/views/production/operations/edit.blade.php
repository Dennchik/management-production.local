...
@section('title', 'Редактирование производственной операции')

@section('content')
	<div class="main-content__content" data-production-operation-form>
		<div class="main-content__header">
			<h1 class="main-content__title">Редактирование производственной операции</h1>
		</div>
		...
		<form class="operation-form" method="POST"
			...
			<div class="operation-form__section">
				...
				<div class="operation-form__components" data-production-operation-inputs>
					@php
						$inputs = $operation->components->where('direction', 'input')->sortBy('sort_order')->values();
					@endphp
										...
										<div class="select__dropdown material-select__select-list _collapse" role="listbox">
											...
											@foreach ($materials as $material)
												<button class="material-select__select-option select__item"
														...
														aria-selected="{{ (int) $component->material_id === (int) $material->id ? 'true' : 'false' }}">
	                                    <span>
			...
			<div class="operation-form__section">
				...
				<div class="operation-form__components" data-production-operation-outputs>
					@php
						$outputs = $operation->components->where('direction', 'output')->sortBy('sort_order')->values();
					@endphp
