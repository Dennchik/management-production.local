		...
		<nav class="sidebar__nav">
			...
			@if ($user?->may('tasks'))
				<div class="sidebar__section">
					...
					<div class="sidebar__submenu">
						<a class="sidebar__link sidebar__link--submenu {{ request()->routeIs('tasks.*') ? 'is-active' : '' }}" href="{{ route('tasks.index') }}">
							<i class="icon-indent-increase icon"></i>
			...
			@if ($user?->may('users'))
				<a class="sidebar__link {{ request()->routeIs('users.*') || request()->routeIs('roles.*') ? 'is-active' : '' }}" href="{{ route('users.index') }}">
